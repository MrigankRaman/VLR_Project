...
CUDA_VISIBLE_DEVICES=1 mpiexec -n 1 python image_adapt/scripts/image_sample.py $MODEL_FLAGS \
...
CUDA_VISIBLE_DEVICES=1 mpiexec -n 1 python image_adapt/scripts/image_sample.py $MODEL_FLAGS \
                            ...
                            --model_path ckpt/cifar10_uncond_50M_500K.pt --base_samples dataset/cifar10c \
                            --D 4 --N 200 --scale 6\
                            --corruption defocus_blur --severity 4 \
                            --save_dir /data/mrigankr/vlr-project/cifar10c/generated/
...
CUDA_VISIBLE_DEVICES=1 mpiexec -n 1 python image_adapt/scripts/image_sample.py $MODEL_FLAGS \
                            ...
                            --model_path ckpt/cifar10_uncond_50M_500K.pt --base_samples dataset/cifar10c \
                            --D 4 --N 200 --scale 6\
                            --corruption elastic_transform --severity 4 \
                            --save_dir /data/mrigankr/vlr-project/cifar10c/generated/
...
CUDA_VISIBLE_DEVICES=1 mpiexec -n 1 python image_adapt/scripts/image_sample.py $MODEL_FLAGS \
                            ...
                            --model_path ckpt/cifar10_uncond_50M_500K.pt --base_samples dataset/cifar10c \
                            --D 4 --N 200 --scale 6\
                            --corruption glass_blur --severity 4 \
                            --save_dir /data/mrigankr/vlr-project/cifar10c/generated/
